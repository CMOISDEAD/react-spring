...
export const SongCard = ({ song, show }: Props) => {
		...
		axios
			...
			.catch((err) => {
				...
				if (user.playlist != null) {
					new_userlist = [...user.playlist, song];
				} else {
					new_userlist = [song];
				}
				dispatch(
	...
	return (
		<div className="responsive-card min-w-[20%] max-w-[20%] h-auto rounded-md bg-[#161616] p-2 my-2 border border-zinc-900 hover:border-zinc-500 relative">
